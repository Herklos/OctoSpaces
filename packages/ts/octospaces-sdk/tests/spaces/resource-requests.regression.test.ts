...
vi.mock('../../src/sync/signed-append.js', () => ({
  appendToInbox: vi.fn(),
  postAnonymousAppend: vi.fn(),
}));

vi.mock('../../src/spaces/identity-link.js', () => ({
...
import { pullInbox } from '../../src/sync/inbox.js';
import { unsealFromRecipient, sealToRecipient } from '../../src/sync/account-seal.js';
import { readObjectTree } from '../../src/spaces/object-index.js';
import { createNode, inviteToNode } from '../../src/spaces/nodes.js';
import { addSpaceMember } from '../../src/spaces/registry.js';
...
} from '../../src/spaces/resource-requests.js';
import type { PendingRequest, ResourceRequest, ResourceGrant } from '../../src/spaces/resource-requests.js';
...
describe('scanResourceRequests — validates kemSig binding', () => {
  ...
  it('FAILS (pre-fix): submitResourceRequest includes kemSig in the sealed request', async () => {
    ...
    const { verifyIdentityLinkBinding, verifyIdentityLinkKeys } = await import('../../src/spaces/identity-link.js');
